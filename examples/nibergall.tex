...
\begin{lemma}
Пусть $\Diamond_a $ и $\Diamond_b $ --- модальности логики $T$, $\Diamond_\star A \equiv \Diamond_a A \vee  \Diamond_b A$.
\begin{align*}
...
\end{itemize}
Осталось применить ту же лемму для $\Diamond_a  \equiv \Diamond_1 T \wedge  \Diamond_* \cdot$ и $\Diamond_b  \equiv \Diamond_0 \Diamond_1 \cdot \vee  \Diamond_* ^2\cdot$.
\begin{itemize}
