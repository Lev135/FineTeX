...
\usepackage[left=2cm, right=2cm, top=1.3cm, bottom=2cm]{geometry} \usepackage[utf8]{inputenc}
\usepackage[russian]{babel} \usepackage{amsthm} \usepackage{amsmath} \usepackage{amssymb}
...
\begin{document}
  ...
  \begin{proof}
    ...
    \begin{itemize}
      \item $J \vdash  \Diamond_* p \rightarrow  \Diamond_* (p \wedge  \neg \Diamond_* p)$ \\
            ...
            \begin{align*}
              J \vdash  \Diamond_0 (\Diamond_1 T \wedge  p) \rightarrow  \Diamond_0 (\Diamond_1 T \wedge  p
              \wedge  \neg \Diamond_0 (\Diamond_1 T \wedge  p))
            \end{align*}
            с точностью до обозначения
            $\Diamond_* \cdot = \Diamond_0 (\Diamond_1 T \wedge  \cdot)$ это и есть требуемое
      ...
      \item $J \vdash  \Diamond_0 \Diamond_1 p \rightarrow  \Diamond_0 \Diamond_1 (p \wedge 
            ...
            по нормальности получаем требуемое
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      \wedge  \Diamond_1 r), \equiv \Diamond_1 ^2(q \wedge  \Diamond_1 r) \vee  \Diamond_* \Diamond_1 (q
      \wedge  \Diamond_1 r)\\
  ...
  \begin{proof}
    \begin{align*}
      J \vdash  \Diamond ^2 p &\leftrightarrow  \Diamond_1 \Diamond_1 p \vee  \Diamond_1 \Diamond_* p
      \vee  \Diamond_* \Diamond_1 p \vee  \Diamond_* \Diamond_* p\\
      &\leftrightarrow  \Diamond_1 T \wedge  \Diamond_* p \vee  \Diamond_0 \Diamond_1 p \vee 
      \Diamond_* ^2 p
    \end{align*}
    Теперь дважды воспользуемся леммой. \\
    Сначала для $\Diamond_a  \equiv \Diamond_0 \Diamond_1 $ и
    ...
    \end{itemize}
    Осталось применить ту же лемму для
    $\Diamond_a  \equiv \Diamond_1 T \wedge  \Diamond_* \cdot$ и
